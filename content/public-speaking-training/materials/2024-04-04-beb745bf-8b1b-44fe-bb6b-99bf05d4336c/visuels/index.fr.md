...
- Livret du participant (ce document)
...
PowerPoint est devenu tellement utilisé qu'il est devenu synonyme de présentation en entreprise. La majeure partie du temps consacré à la préparation d'une présentation est passé sur PowerPoint. En réalité, une bonne présentation s'appuie sur 3 piliers qui servent à communiquer le message efficacement, et le temps de préparation adéquat est accordé à chacun des piliers.

![[elements/Les trois piliers d'une bonne présentation]]
...
Voir le [module message](../message/) pour expliquer les concepts de base du message et le tous premiers outils du storytelling.
...
![Slide exemple 3](slide-example-3.svg)

![Slide exemple 10](slide-example-10.png)

![Slide exemple 8](slide-example-8.png)
