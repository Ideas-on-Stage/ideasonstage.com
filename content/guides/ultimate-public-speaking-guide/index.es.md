...
description		= "Técnicas de oratoria, gestión del estrés, resolución de problemas frecuetnes: cómo hablar en público con facilidad."
categories		= [ "Hablar en Público" ]
url 				= "/guia-definitiva-hablar-en-publico/"
picture		 	= "public-speaking.jpg"
summary			= "Esta guía te proporcionará los consejos necesarios para hablar en público con éxito, ya sea en una reunión o frente a una audiencia de miles de personas. Hablar en público es un ejercicio estresante para la mayoría de personas. ¿Cómo comportarse? ¿Cuáles son los errores que debes evitar? Gracias a esta guía, escrita por profesionaes en comunicación interpersonal, podrás aprender las técnicas necesarias para una comunicación oral efectiva, y controlar el estrés."
+++
## ¿Quiénes somos?
Ideas on Stage es una empresa especializada en presentaciones empresariales. Hemos entrenado y formado a miles de ponentes. Tenemos una larga experiencia en la preparación de presentaciones estilo TED y TEDx con más de 300 ponentes preparados y docenas de eventos TEDx en Francia, Reino Unido y Estados Unidos.

Para preparar a los ponentes, utilizamos técnicas clásicas para hablar en público, pero vamos mucho más allá al poner las nuevas tecnologías al servicio del habla, por ejemplo, con la realidad virtual. También utilizamos técnicas de storytelling y creación visual.
