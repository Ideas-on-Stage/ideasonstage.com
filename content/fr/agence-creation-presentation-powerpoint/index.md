...
{{< shortcode-text2-img1
  img="/img/inserts/presentation-creation-service-10.jpg"
  alt="Conseil en communication"
...
{{< shortcode-img1-text2
  img="/img/inserts/presentation-creation-service-12.jpg"
  alt="Storytelling"
  class="margin-top margin-bottom" >}}
### Storytelling
...
{{< shortcode-img1-text2
  img="/img/inserts/presentation-creation-service-52.jpg"
...
{{< shortcode-text2-img1
  img="/img/inserts/presentation-creation-service-54.jpg"
  alt="Parfaits au pixel près"
  class="margin-top margin-bottom" >}}
### Parfaits au pixel près
...
{{< shortcode-img1-text2
  img="/img/inserts/presentation-creation-service-55.jpg"
  alt="Légère comme une plume"
  class="margin-top margin-bottom" >}}
