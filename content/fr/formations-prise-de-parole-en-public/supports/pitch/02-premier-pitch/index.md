...
title: II. Premier Pitch
description: "Apprendre à identifier les messages clés et à les organiser en un premier pitch."
weight: 210002
courseID: 2100
hugopublishpath: /Users/pmorsa/Sites/Hugo/ideasonstage.com/content/fr/formations-prise-de-parole-en-public/supports/pitch/02-premier-pitch/index.md
---


Nous allons immédiatement commencer à travailler sur notre premier pitch. Pour l'instant, vous pouvez mettre de côté le sujet que vous avez préparé. Pour cette étude de cas, vous allez travailler sur la vente d'un produit fictif. 

- Vous travaillez en binômes.
- Vous devez tous pitcher le même produit.
- À la fin, vous pourrez tous voter pour votre pitch préféré.


## 1 Le produit à pitcher

> Note : pour vous faciliter la vie, nous avons pris un produit réel, mais les tarifs et les autres éléments sont fictifs.

Vous êtes commercial chez auum. Votre entreprise propose une machine qui lave instantanément les verres. L'objectif est de supprimer les gobelets en carton à usage unique pour réduire le gaspillage.

https://www.auum.com/solution-nettoyage-entreprise-auum

Vous avez rendez-vous avec le responsable des hôtels d'un grand groupe hôtelier français, et vous aimeriez le convaincre d'installer ces machines dans le hall d'accueil de tous ses hôtels, soit environ 200 hôtels en France et 500 hôtels dans le monde.


## 2 Ce que vous savez

> Note : ces éléments sont fictifs et ne reflètent pas la réalité.

- Une machine coûte 3000 €. La durée de vie de la machine est d'environ 5 ans.
- Chaque verre adapté est vendu 5 € pièce, et il faut compter environ 50 verres sur la durée de vie de la machine.
- Pour simplifier l'étude de cas, les coûts des consommables et de la maintenance sont considérés comme négligeables.
- Vous n'avez pas de marge de manœuvre sur les prix, vous ne pouvez pas offrir de réduction car les prix sont déjà très bas.
- En comparaison, le coût d'achat direct des gobelets en carton par an par hôtel est estimé à 600 €.
- Votre client est peu sensible à la question écologique. Ce qu'il cherche avant tout, ce sont des moyens d'attirer plus de clients dans ses hôtels car il a des objectifs ambitieux de croissance.


## 3 Méthodologie de préparation du pitch

Maintenant que nous avons les éléments de départ, nous allons voir la méthodologie que nous préconisons pour la préparation d'un pitch :

- Définissez votre ABC,
- puis votre objectif de transformation,
- puis votre parcours de transformation de l'auditoire.
- Sur base de ces éléments **choisissez** les éléments les plus importants pour construire votre pitch. Vous aurez plus d'informations à la fin de ce module. 


## 4 ABC : Audience, Besoin, Contexte
...
## 7 Parcours de transformation de l'audience
...
## 8 Construction du premier pitch

- Sur base de ces éléments **choisissez** les éléments les plus importants pour construire votre pitch. Vous aurez plus d'informations à la fin de ce module. qui respecte la structure suivante :
	- Problème : quel est le problème que nous voulons résoudre (le besoin auquel nous voulons répondre)
	- Solution : quelle est la solution que nous proposons ?
	- Appel à l'action : que voulez-vous que votre prospect fasse ?

> Préparez votre pitch. Celui-ci doit durer au maximum 1'30".


## 9 Présentations et debrief

Chaque groupe présente son pitch, puis un debrief de groupe est réalisé :

- Qu'est-ce qui fonctionne ?
- Qu'est-ce qui ne fonctionne pas ?
- Y a-t-il des éléments non verbaux qui vous donnent envie de croire au pitch ? Des éléments qui vous bloquent ?

Maintenant que nous avons fait ce premier exercice de pitch, nous allons y incorporer des éléments d'art oratoire : posture, langage non verbal, etc.
